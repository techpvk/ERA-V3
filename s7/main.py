...
from models.model2 import Net as Model2
from models.model3 import Net as Model3
...
def get_transforms(model_name):
    # Base transformations that are common
    base_transforms = [
        transforms.ToTensor(),
    ...
    # Combine model-specific transforms with base transforms
    train_transforms = transforms.Compose(
        model_transforms.get(model_name, model_transforms[model_name])
    )
